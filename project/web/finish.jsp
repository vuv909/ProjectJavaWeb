    ...
    <body>
       ...
       <!-- Navigation-->
        ...
        <div class="container pt-2 border-bottom" style="padding:0;">
                ...
                <div class="col-auto" style="padding:0;">
                    <nav aria-label="breadcrumb ">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a id="breaditem3" href="finishorder">Finish</a></li>
                        </ol>
                    </nav>
                </div>    
            </div>
            ...
            <div class="alert alert-dark text-center col-7 mt-5" role="alert">
                Đặt hàng thành công cảm ơn bạn rất nhiều&nbsp;<i class="bi bi-heart"></i><i class="bi bi-heart"></i><i class="bi bi-heart"></i>
                <br/>
                <button class="btn btn-primary mt-3" style="color: white"><a href="home"style="color: white;text-decoration: none">Tiếp tục mua hàng ...</a></button> 
            </div>
        </div>
