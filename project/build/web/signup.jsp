        ...
        <div class="container align-self-center" style="margin-top: 5%;margin-bottom: 10%">
            <div class="row justify-content-center">
                <div class="col-8 card">  
                    <div class="card-header text-center" style="font-weight: bolder;font-size: larger">Sign up</div>      
                    <div class="card-body">
                        <form action="signup" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="displayname" name="displayname" aria-describedby="emailHelp" required="">
                            ...
                            <div class="mb-3">
                                <label for="passwordagain" class="form-label">Enter password again</label>
                                <input type="password" class="form-control" id="passwordagain" name="passwordagain" required="">
                            </div>
                            
                            <div class="mb-3">
                                <h3 style="color: red">${requestScope.errortyping}</h3>
                            </div>
